...
def draw_cat_plot():
    ...
    fig = sns.catplot(data=df_cat, kind='bar', x='variable',hue='value', col='cardio', y='total', ci=None).set_axis_labels('variable', 'total')
    fig = fig.fig
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, fmt='.1f', square=True, cbar_kws = {'shrink': 0.5}, annot=True, center=0)
