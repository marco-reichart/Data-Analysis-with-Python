...
def calculate_demographic_data(print_data=True):
    ...
    top_IN_occupation = df[(df['salary'] =='>50K') & (df['native-country'] == 'India')].groupby('occupation').size().reset_index(name='count').sort_values(by='count', ascending=False)['occupation'].value_counts().idxmax()
